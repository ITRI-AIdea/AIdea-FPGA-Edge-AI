...
#
#  Training script for AIdea "FPGA Edge AI – AOI Defect Classification" competition tutorial.
...
def run_main():
    ...
    ap.add_argument('-t', '--tfrec_dir', type=str, default='tfrecords',
                    help='Path of folder containing TFRecord files.')
    ap.add_argument('-b', '--batchsize', type=int, default=50,
                    help='Training batchsize. Must be an integer. Default is 50.')
    ...
    ap.add_argument('-cf', '--chkpt_dir', type=str, default='float_model',
                    help='Path and name of folder for storing Keras checkpoints. Default is float_model')
